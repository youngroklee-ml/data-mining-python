...
# Please note that python's position index start from 0, so you should use positions 1 and 3.
D1[1, 3]
...
# `StandardScaler` uses population variance formula instead of sample variance formula, 
# so the results are slightly different from book example.
